 ...
 * and PassengerTrackingMap.native.tsx: a pill/circle dot (route-blue fill,
 * white halo ring, drop shadow) instead of a vehicle-specific arrow/icon.
 * Symmetrical, so the parent <MarkerAnimated> should pass rotation={0} — the
 * dot never needs to rotate with heading.
 *
...
interface DriverMarkerProps {
   ...
   *  their anchor/rotation props off this. The marker's own visual no longer
