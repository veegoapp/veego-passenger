...
export const ar: typeof en = {
  ...
  tx_detail_title: 'تفاصيل العملية',
  tx_detail_type: 'النوع',
  tx_detail_date: 'التاريخ',
  tx_detail_reference: 'الرقم المرجعي',
  tx_detail_amount: 'المبلغ',
  tx_kind_deposit: 'شحن',
  tx_kind_payment: 'دفع',
  tx_kind_refund: 'استرداد',
  tx_kind_bonus: 'مكافأة',
  tx_cat_wallet_topup: 'شحن المحفظة',
  tx_cat_shuttle_payment: 'دفع رحلة باص',
  tx_cat_shuttle_refund: 'استرداد رحلة باص',
  tx_cat_shuttle_debt_settlement: 'تسوية دين نقدي',
  tx_cat_ride_payment: 'دفع رحلة',
  tx_cat_ride_refund: 'استرداد رحلة',
  tx_cat_ride_change: 'باقي من السائق',
  tx_cat_referral_bonus: 'مكافأة إحالة',
  tx_cat_bonus_target: 'مكافأة أداء',
  tx_cat_admin_adjustment: 'تعديل رصيد',
  tx_cat_generic_topup: 'شحن',
  tx_cat_generic_payment: 'دفع',
  tx_cat_generic_refund: 'استرداد',
  ...
  referral_menu_label: 'ادعُ أصدقاءك واربح',
  referral_title: 'ادعُ أصدقاءك',
  referral_subtitle: 'شارك كودك واربح عند انضمامهم',
  referral_your_code: 'كود الإحالة الخاص بك',
  referral_share_cta: 'مشاركة الدعوة',
  referral_share_message: 'انضم لتطبيق VeeGo باستخدام كودي {code} وهنكسب مكافأة الاتنين! نزّل التطبيق وحط الكود ده وقت التسجيل.',
  referral_how_it_works: 'إزاي تشتغل',
  referral_how_1: 'شارك كودك مع صديقك',
  referral_how_2: 'يدخله وقت إنشاء حسابه',
  referral_how_3: 'الاتنين تاخدوا المكافأة بعد استيفاء الشروط',
  referral_stat_total: 'المدعوون',
  referral_stat_rewarded: 'تم صرفها',
  referral_stat_pending: 'قيد الانتظار',
  referral_stat_earned: 'المكتسب',
  referral_history_title: 'دعواتك',
  referral_history_empty: 'لسه ما دعيتش حد',
  referral_status_pending: 'قيد الانتظار',
  referral_status_rewarded: 'تم الصرف',
  referral_status_cancelled: 'ملغي',
  referral_load_error: 'تعذر تحميل بيانات الإحالة',
  referral_code_field_placeholder: 'كود إحالة صديقك (اختياري)',
  ...
  ticket_session_slow: 'الأمر بياخد وقت أطول من المتوقع. حجزك ممكن يكون اتم فعلاً — راجع "رحلاتي"، أو أعد تحميل التذكرة.',
  go_back: 'رجوع',
  ...
  payment_methods_instapay: 'إنستاباي',
  accepts_instapay: 'يقبل إنستاباي',
  instapay_title: 'الدفع عبر إنستاباي',
  instapay_open_app: 'فتح إنستاباي',
  instapay_ive_paid: 'لقد دفعت',
  instapay_waiting_confirmation: 'في انتظار تأكيد الاستلام من السائق',
  instapay_scan_or_tap: 'امسح رمز الاستجابة السريعة أو اضغط أدناه لفتح إنستاباي',
  ...
  booking_unclear_title: 'حصل خطأ',
  booking_unclear_msg: 'مش عارفين نتأكد إن حجزك اتم صح. لو اتخصم منك فلوس، تواصل مع الدعم قبل ما تحاول تحجز تاني — متحجزش مرتين.',
  booking_timeout_msg: 'الطلب استغرق وقت طويل ومش عارفين نتأكد إنه اتم صح. راجع "رحلاتي" قبل ما تحاول تاني — لو مفيش حجز ظاهر، آمن إنك تجرب تاني.',
