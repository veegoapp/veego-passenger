export const en = {
  ...
  active: 'Active',
  boarded_badge: 'Boarded',
  waiting_for_passengers: 'Waiting for passengers',
  seats_filled: '{current}/{min} seats filled',
  cairo_tz: 'Cairo',
  ...
  tx_kind_deposit: 'Top-up',
  tx_kind_payment: 'Payment',
  tx_kind_refund: 'Refund',
  tx_kind_bonus: 'Bonus',
  tx_cat_wallet_topup: 'Wallet top-up',
  tx_cat_shuttle_payment: 'Shuttle ride payment',
  tx_cat_shuttle_refund: 'Shuttle ride refund',
  tx_cat_shuttle_debt_settlement: 'Cash debt settlement',
  tx_cat_ride_payment: 'Ride payment',
  tx_cat_ride_refund: 'Ride refund',
  tx_cat_ride_change: 'Change from driver',
  tx_cat_referral_bonus: 'Referral reward',
  tx_cat_bonus_target: 'Performance bonus',
  tx_cat_admin_adjustment: 'Balance adjustment',
  tx_cat_generic_topup: 'Top-up',
  tx_cat_generic_payment: 'Payment',
  tx_cat_generic_refund: 'Refund',
  ...
  rate_ride_with_driver: 'How was your ride with {driver}?',
  ...
  referral_menu_label: 'Invite Friends & Earn',
  referral_title: 'Invite Friends',
  referral_subtitle: 'Share your code, earn when they join',
  referral_your_code: 'Your referral code',
  referral_share_cta: 'Share invite',
  referral_share_message: 'Join VeeGo with my code {code} and we both get a reward! Download the app and enter this code when you sign up.',
  referral_how_it_works: 'How it works',
  referral_how_1: 'Share your code with a friend',
  referral_how_2: 'They enter it when creating their account',
  referral_how_3: 'You both get rewarded once the requirements are met',
  referral_stat_total: 'Invited',
  referral_stat_rewarded: 'Rewarded',
  referral_stat_pending: 'Pending',
  referral_stat_earned: 'Earned',
  referral_history_title: 'Your invites',
  referral_history_empty: "You haven't invited anyone yet",
  referral_status_pending: 'Pending',
  referral_status_rewarded: 'Rewarded',
  referral_status_cancelled: 'Cancelled',
  referral_load_error: 'Could not load your referral info',
  referral_code_field_placeholder: "Friend's referral code (optional)",
  ...
  fare_breakdown_title: 'Fare Breakdown',
  gross_fare: 'Gross Fare',
  wallet_deduction_line: 'Wallet Deduction',
  net_cash_payable: 'Net Cash Payable',
  close: 'Close',
  ...
  payment_methods_instapay: 'InstaPay',
  accepts_instapay: 'Accepts InstaPay',
  instapay_title: 'Pay with InstaPay',
  instapay_open_app: 'Open InstaPay',
  instapay_ive_paid: "I've Paid",
  instapay_waiting_confirmation: 'Waiting for driver to confirm receipt',
  instapay_scan_or_tap: 'Scan the QR code or tap below to open InstaPay',
  ...
  say_hello_driver: 'Say hello to your driver!',
  ...
  suspended_title: 'Your account has been suspended due to repeated no-shows.',
  suspended_body: 'Please contact support to reactivate it.',
  ...
  on_board_label: 'On board',
  updating_driver_location: 'Updating driver location…',
  next_station_label: 'Next station',
  boarding_station_label: 'Boarding station',
  on_board_title: 'You are on board',
  on_board_sub: "Enjoy your ride — we'll notify you on arrival",
  eta_to_station_label: 'Time to your station',
  current_passengers_label: 'Current passengers',
  live_badge: 'live',
