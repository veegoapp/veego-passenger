const en = {
  ...
  paymob_checkout_title: 'Secure Checkout',
  recharge_starting: 'Starting secure checkout…',
  recharge_confirming_title: 'Confirming payment',
  recharge_confirming_body: 'Please wait while we confirm your payment with Paymob…',
  recharge_cancelled_title: 'Recharge cancelled',
  recharge_cancelled_body: 'You closed the checkout before completing payment. No amount was charged.',
  recharge_failed_title: 'Recharge failed',
  recharge_failed_body: 'Your payment could not be completed. No amount was added to your balance.',
  recharge_timeout_title: 'Still processing',
  recharge_timeout_body: 'Paymob is still confirming your payment. Your balance will update automatically once it clears — pull to refresh in a moment.',
  recharge_start_error_title: 'Could not start checkout',
  load_more: 'Load more',
  search_no_match: 'No lines or stations match your search query.',
  onboarding_tag1: 'All-in-one mobility',
  onboarding_title1: 'One app,\nevery way to move',
  onboarding_body1: 'Shuttle, car rides, scooters, and delivery — all in a single VeeGo account.',
  onboarding_tag2: 'Choose your ride',
  onboarding_title2: 'Move your way,\nevery time',
  onboarding_body2: 'Book a shuttle seat, call a car, grab a scooter, or send a delivery — whatever fits your trip.',
  onboarding_tag3: 'All in one place',
  onboarding_title3: 'Everything connected,\nin one place',
  onboarding_body3: 'Book, track, and pay from a single wallet. One simple mobility experience.',
...
const ar: typeof en = {
  ...
  paymob_checkout_title: 'الدفع الآمن',
  recharge_starting: 'جارٍ بدء الدفع الآمن…',
  recharge_confirming_title: 'جارٍ تأكيد الدفع',
  recharge_confirming_body: 'يرجى الانتظار بينما نؤكد عملية الدفع مع Paymob…',
  recharge_cancelled_title: 'تم إلغاء الشحن',
  recharge_cancelled_body: 'أغلقت صفحة الدفع قبل إتمام العملية. لم يتم خصم أي مبلغ.',
  recharge_failed_title: 'فشل الشحن',
  recharge_failed_body: 'تعذر إتمام عملية الدفع. لم تتم إضافة أي مبلغ إلى رصيدك.',
  recharge_timeout_title: 'جارٍ المعالجة',
  recharge_timeout_body: 'لا تزال Paymob تؤكد عملية الدفع. سيتم تحديث رصيدك تلقائيًا بمجرد تأكيدها — اسحب للتحديث بعد قليل.',
  recharge_start_error_title: 'تعذر بدء الدفع',
  load_more: 'تحميل المزيد',
  search_no_match: 'لا توجد خطوط أو محطات تطابق بحثك.',
  onboarding_tag1: 'منصة تنقل شاملة',
  onboarding_title1: 'تطبيق واحد،\nكل وسائل التنقل',
  onboarding_body1: 'باص، سيارة، سكوتر، وتوصيل — كله في حساب VeeGo واحد.',
  onboarding_tag2: 'اختر رحلتك',
  onboarding_title2: 'تنقل بطريقتك،\nفي كل مرة',
  onboarding_body2: 'احجز مقعد باص، اطلب سيارة، خذ سكوتر، أو ابعت طرد — أيًا كان ما يناسب رحلتك.',
  onboarding_tag3: 'كله في مكان واحد',
  onboarding_title3: 'كل حاجة مربوطة،\nفي مكان واحد',
  onboarding_body3: 'احجز، تابع رحلتك، وادفع من محفظة واحدة. تجربة تنقل بسيطة.',
