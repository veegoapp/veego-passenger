...
export function DriverSearching({ visible }: DriverSearchingProps) {
  ...
  const scale = pulseRing.interpolate({
    inputRange: [0, 1],
    outputRange: [0.8, 1.4],
  });

  const opacity = pulseRing.interpolate({
    inputRange: [0, 0.5, 1],
...
const styles = StyleSheet.create({
  ...
  content: { alignItems: 'center', paddingHorizontal: 24, gap: 16, paddingBottom: 8 },
